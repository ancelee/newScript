/*
脚本名
更新时间：2020-12-31 00:00
脚本说明：脚本说明
脚本兼容: QuantumultX, Surge, Loon, JSBox, Node.js
// quantumultx
[task_local]
#脚本名
11 9 * * * https://xxx, tag=脚本名, img-url=https://xxx, enabled=true
// Loon
[Script]
cron "11 9 * * *" script-path=https://xxx,tag=脚本名
// Surge
脚本名 = type=cron,cronexp=11 9 * * *,wake-system=1,timeout=20,script-path=https://xxx
 */
const $ = new Env('脚本名');
...
//做任务
function doTask(taskId, itemId, timeout = 0) {
    return new Promise((resolve) => {
        setTimeout(() => {
            let url = {
                url: `${JD_API_HOST}url`,
